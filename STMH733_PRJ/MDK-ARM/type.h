...
/* CXPI ?????? */
{
  ...
  byte  FrameInfo;
  byte  FrameData[12];
  byte  FrameCheck; //FrameCheck --> FrameCheckType 20130516 WWS
} ;
...
extern struct CDFTableStruct  CDFData[3];
extern short int CDFcount;
/* 0:FrameInfo, 1-12:byte0-11, 13:Check, */
extern byte DataReceived[14];
/* 0:FrameInfo, 1-12:byte0-11, 13:Check, */
extern byte DataToBeSent[14];
extern byte *DataPointer;
extern enum CXPI_States CXPIState;
extern byte PID[];
extern byte RxByteCount;
extern byte Framelength;
extern byte event;
extern byte TxBuffer[1];
extern byte EventData[14];
extern byte PTYPEfield[3];
#endif
